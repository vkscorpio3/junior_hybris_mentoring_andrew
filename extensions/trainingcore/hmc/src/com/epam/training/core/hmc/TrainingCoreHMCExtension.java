 ...
 *  
 */
package com.epam.training.core.hmc;
...
/**
 * Provides necessary meta information about the trainingcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class TrainingCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TrainingCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.epam.training.core.hmc.locales";
