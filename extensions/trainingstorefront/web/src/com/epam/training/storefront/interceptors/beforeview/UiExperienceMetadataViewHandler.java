...
import com.epam.training.storefront.interceptors.BeforeViewHandler;
...
public class UiExperienceMetadataViewHandler implements BeforeViewHandler
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.epam.training.storefront.interceptors.BeforeViewHandler#beforeView(javax.servlet.http.
